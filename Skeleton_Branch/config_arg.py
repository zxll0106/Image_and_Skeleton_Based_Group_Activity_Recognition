...
class Config(object):
    ...
    def __init__(self, dataset_name):
        ...
        if dataset_name == 'volleyball':
            self.data_path = ''  # data path for the volleyball dataset
            self.train_seqs = [1, 3, 6, 7, 10, 13, 15, 16, 18, 22, 23, 31, 32, 36, 38, 39, 40, 41, 42, 48, 50, 52, 53,
                               54,
            ...
            self.data_path = ''  # data path for the collective dataset

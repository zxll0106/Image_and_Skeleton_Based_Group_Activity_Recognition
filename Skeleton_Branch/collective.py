...
from config import cfg as cfg_hrnet
...
class CollectiveDataset(data.Dataset):
    ...
    def load_samples_sequence(self,select_frames):
        ...
        for i, (sid, src_fid, fid) in enumerate(select_frames):
            ...
            with open('./data/skeleton_data_collective'+'/seq%02d/frame%04d.json'%(sid,fid)) as load_f:
            ...
            temp_keypoints[:,:,:,0:2]=temp_keypoints[:,:,:,0:2]+0.5
            temp_keypoints=temp_keypoints.tolist()
            ...
            # print('/seq%02d/frame%04d.json' % (sid, fid))
        ...
        return images, bboxes,  actions, activities, bboxes_num,keypoints
